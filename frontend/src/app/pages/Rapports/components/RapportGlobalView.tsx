...
import { canViewSection } from '@/config/rapportPermissions';
...
export function RapportGlobalView({ data, userRole }: RapportGlobalViewProps) {
  if (!data) {
    return (
      <Card>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* CA - Visible uniquement pour gestionnaire */}
        {canViewSection(userRole, 'ca_total') && (
          <Card>
        ...
        {/* Nombre de ventes - Visible pour gérant et coiffeur */}
        {canViewSection(userRole, 'nb_ventes_jour') && !canViewSection(userRole, 'ca_total') && (
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <CardContent>
              <div className="text-2xl font-bold">{data.statistiques.nb_ventes}</div>
              ...
              <div className="mt-3 space-y-1 text-xs text-muted-foreground">
                <div className="flex justify-between">
                  ...
                  <span>{data.statistiques.nb_clients}</span>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        {/* Bénéfice net - Uniquement gestionnaire */}
        {canViewSection(userRole, 'benefices') && (
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2">
        ...
        {/* Dépenses - Uniquement gestionnaire */}
        {canViewSection(userRole, 'depenses') && (
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <CardContent>
              ...
              <div className="mt-3 space-y-1 text-xs text-muted-foreground">
                ...
                {canViewSection(userRole, 'salaires') && (
                  <div className="flex justify-between">
                    <span>Salaires</span>
      ...
      {/* Détails CA - Visible pour tous sauf le CA total masqué */}
      {canViewSection(userRole, 'ca_details') && (
        <Card>
          <CardHeader>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Dépenses par catégorie - Uniquement gestionnaire */}
        {canViewSection(userRole, 'depenses') && (
          <Card>
            <CardHeader>
        ...
        {/* Salaires détail - Uniquement gestionnaire */}
        {canViewSection(userRole, 'salaires') && (
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
      ...
      {/* Statistiques générales - Visible pour tous */}
