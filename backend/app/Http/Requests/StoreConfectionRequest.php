...
class StoreConfectionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // ✅ variante_id au lieu de produit_id
            'details'                       => 'required|array|min:1',
            'details.*.variante_id'         => 'required|exists:produit_variantes,id',
            'details.*.quantite_utilisee'   => 'required|numeric|min:0.01',
    ...
    public function messages(): array
    {
        return [
            ...
            // ✅ messages variante_id
            'details.*.variante_id.required' => 'La variante est obligatoire pour chaque détail',
            'details.*.variante_id.exists'   => "Une des variantes sélectionnées n'existe pas",

            'details.*.quantite_utilisee.required' => 'La quantité utilisée est obligatoire',
            'details.*.quantite_utilisee.numeric'  => 'La quantité doit être un nombre',
            'details.*.quantite_utilisee.min'      => 'La quantité doit être supérieure à 0',
